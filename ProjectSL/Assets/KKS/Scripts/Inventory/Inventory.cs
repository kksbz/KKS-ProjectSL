...
public class Inventory : Singleton<Inventory>
{
    ...
    public GameObject equipSlotPrefab; // 장착슬롯 프리팹
    public GameObject totalSlotPrefab; // 통합슬롯 프리팹
    public GameObject equipSlotPanel; // 장착슬롯 패널
    public GameObject equipInvenPanel; // 장비 장착 인벤토리 패널
    public GameObject totalInvenPanel; // 통합 인벤토리 패널
    public Image equipInvenImage; // 장비 장착 인벤토리 패널 상단 이미지
    public ItemDescriptionPanel descriptionPanel; // 아이템 설명창 패널
    public SelectPanel selectPanel; // 선택창 패널
    public Image topImage; // 인벤토리 UI상단 표시 이미지
    public TMP_Text topText; // 인벤토리 UI상단 표시 텍스트
    public TMP_Text possessionSoul; // 보유소울 표시 텍스트
    public GameObject goBack; // 인벤토리 UI하단 뒤로가기
    ...
    public List<EquipSlot> equipSlots = new List<EquipSlot>(); // 장착슬롯 리스트
    public List<Slot> totalSlots = new List<Slot>(); // 통합슬롯 리스트
    public IPublicSlot selectSlot; // 선택한 슬롯
    ...
    public void AddItem(ItemData item)
    {
        ...
        {
            // 아이템데이터 테이블에서 습득한 아이템의 ID값과 같은 아이템 캐싱
        ...
        foreach (ItemData _item in inventory)
        {
            if (_item != null)
            {
                if (_item.itemID == item.itemID)
                {
                    ...
                    {
                        // 아이템의 보유수량과 획득한 아이템의 보유수량의 합이 최대보유수량을 초과할 때
